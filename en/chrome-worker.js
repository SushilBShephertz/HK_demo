var apiKey = "3003776fa8a9b6dcfca5b06dc40093dc75dbb2844dc5260c37c561bb5cf25b72"
var CLICK_URL 
var iconURL = "http://13.88.191.53/content/dam/aia/img/vitality-logo-card.png"
		...
		return fetch(FETCH_ENDPOINT).then(function(response) {
		    return response.json().then(function(json) {
				...
				for(var i=0;i< jsonOBJECT.length;i++){
					CLICK_URL = "https://13.88.191.53/en/";
					actionOne = null;
					actionTwo = null;
